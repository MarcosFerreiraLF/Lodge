                    ...
                    <tbody>
                        ...
                        <c:forEach var="user" items="${lista}">
                            <tr>
                                <td>${user.nome} </td>
                                <td>${user.login} </td>
                                <td> <a href="${pageContext.request.contextPath}/excluir?id=<c:out value="${user.id}"/>">Excluir</a> <a href="${pageContext.request.contextPath}/editar?id=<c:out value="${user.id}"/>">Editar</a></td>
